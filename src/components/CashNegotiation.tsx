...
const S: Record<string, React.CSSProperties> = {
  ...
  sel: { border: 'none', background: 'transparent', color: '#0071e3', fontSize: 15, outline: 'none', padding: 0, textAlign: 'right', direction: 'rtl', flex: 1, minWidth: 0, appearance: 'none', WebkitAppearance: 'none' } as any,
  selTime: { border: 'none', background: 'transparent', color: '#0071e3', fontSize: 15, outline: 'none', padding: 0, textAlign: 'right', direction: 'rtl', width: 74, flexShrink: 0, appearance: 'none', WebkitAppearance: 'none' } as any,
