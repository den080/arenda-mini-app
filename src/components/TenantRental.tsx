...
import CashNegotiation from './CashNegotiation'
import BillUploader from './BillUploader'
import { ensureNextPayment } from '../lib/nextPayment'
import Chat from './Chat'
import { BottomNav, Progress, showToast } from './ui'
import { T } from '../theme'
...
export function TenantRental({ contract, tab, setTab }: { contract: any; tab: string; setTab: (t: string) => void }) {
